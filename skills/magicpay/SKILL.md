...
description: Use when an AI agent needs MagicPay for setup, exact balances,
  transfers, x402, Memory, agent-direct browser payments, approval, payment
  submission, or reconciliation. The host built-in browser owns page analysis,
  form filling, the exact final click, and result interpretation.
---
