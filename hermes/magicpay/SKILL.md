---
name: magicpay
description: Use when an AI agent needs MagicPay for first-time setup, exact
  balance checks, crypto transfers and reconciliation, x402, protected Memory,
  approval, or supported login, identity, checkout, donation, subscription,
