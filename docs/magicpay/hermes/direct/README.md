...
```text
Install the `magicpay` skill in Hermes from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.30 using `magicpay-hermes-v0.1.30.zip`. Place the extracted `magicpay/` folder directly inside `~/.hermes/skills/`.
...
1. Download `magicpay-hermes-v0.1.30.zip` from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.30.
...
Use this fallback only if you want to manage the `magicpay/` folder yourself instead of asking Hermes to install it from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.30 using `magicpay-hermes-v0.1.30.zip`.

1. Download `magicpay-hermes-v0.1.30.zip`.
