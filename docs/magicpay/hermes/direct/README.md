...
```text
Install the `magicpay` skill in Hermes from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.43 using `magicpay-hermes-v0.1.43.zip`. Place the extracted `magicpay/` folder directly inside `~/.hermes/skills/`.
...
1. Download `magicpay-hermes-v0.1.43.zip` from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.43.
...
Use this fallback only if you want to manage the `magicpay/` folder yourself instead of asking Hermes to install it from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.43 using `magicpay-hermes-v0.1.43.zip`.

1. Download `magicpay-hermes-v0.1.43.zip`.
