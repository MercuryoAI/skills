...
```text
Install the `magicpay` skill in OpenClaw from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.26 using `magicpay-openclaw-v0.1.26.zip`. Place the extracted `magicpay/` folder directly inside `skills/` or `~/.openclaw/skills/`.
...
1. Download `magicpay-openclaw-v0.1.26.zip` from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.26.
...
Use this fallback only if you want to manage the `magicpay/` folder yourself instead of asking OpenClaw to install it from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.26 using `magicpay-openclaw-v0.1.26.zip`.

1. Download `magicpay-openclaw-v0.1.26.zip`.
