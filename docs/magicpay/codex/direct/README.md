...
3. Ask Codex to attach to an approved prepared login, identity, checkout, donation, subscription, or payment page, run `magicpay find-form`, and fill for review with `magicpay resolve-form <fillRef> --no-submit`.
