...
```text
Install the `magicpay` skill in Codex from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.15 using `magicpay-codex-v0.1.15.zip`. Place the extracted `magicpay/` folder directly inside `$CODEX_HOME/skills/` or `~/.codex/skills/`.
...
1. Download `magicpay-codex-v0.1.15.zip` from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.15.
...
Use this fallback only if you want to manage the `magicpay/` folder yourself instead of asking Codex to install it from https://github.com/MercuryoAI/skills/releases/tag/magicpay-v0.1.15 using `magicpay-codex-v0.1.15.zip`.

1. Download `magicpay-codex-v0.1.15.zip`.
