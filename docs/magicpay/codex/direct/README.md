...
```text
Install the `magicpay` skill in Codex from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.45 using `magicpay-codex-v0.1.45.zip`. Place the extracted `magicpay/` folder directly inside `$CODEX_HOME/skills/` or `~/.codex/skills/`.
...
1. Download `magicpay-codex-v0.1.45.zip` from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.45.
...
Use this fallback only if you want to manage the `magicpay/` folder yourself instead of asking Codex to install it from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.45 using `magicpay-codex-v0.1.45.zip`.

1. Download `magicpay-codex-v0.1.45.zip`.
