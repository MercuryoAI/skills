...
```text
Install the `magicpay` skill for a compatible AI agent from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.49 using `magicpay-general-agent-v0.1.49.zip`. Place the extracted `magicpay/` folder directly inside `.agents/skills/` or `~/.agents/skills/`.
...
1. Download `magicpay-general-agent-v0.1.49.zip` from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.49.
...
Use this fallback only if you want to manage the `magicpay/` folder yourself instead of asking General Agent to install it from https://github.com/nuanu-ai/skills/releases/tag/magicpay-v0.1.49 using `magicpay-general-agent-v0.1.49.zip`.

1. Download `magicpay-general-agent-v0.1.49.zip`.
