...
```text
Install the `agentbrowse` skill in Claude Code from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.8 using `agentbrowse-claude-code-v0.1.8.zip`. Place the extracted `agentbrowse/` folder directly inside `.claude/skills/` or `~/.claude/skills/`.
...
1. Download `agentbrowse-claude-code-v0.1.8.zip` from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.8.
...
Use this fallback only if you want to manage the `agentbrowse/` folder yourself instead of asking Claude Code to install it from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.8 using `agentbrowse-claude-code-v0.1.8.zip`.

1. Download `agentbrowse-claude-code-v0.1.8.zip`.
...
This guide is for AgentBrowse v0.1.8.
