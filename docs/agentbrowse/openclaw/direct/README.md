...
```text
Install the `agentbrowse` skill in OpenClaw from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.16 using `agentbrowse-openclaw-v0.1.16.zip`. Place the extracted `agentbrowse/` folder directly inside `skills/` or `~/.openclaw/skills/`.
...
1. Download `agentbrowse-openclaw-v0.1.16.zip` from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.16.
...
Use this fallback only if you want to manage the `agentbrowse/` folder yourself instead of asking OpenClaw to install it from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.16 using `agentbrowse-openclaw-v0.1.16.zip`.

1. Download `agentbrowse-openclaw-v0.1.16.zip`.
