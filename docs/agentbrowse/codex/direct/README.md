...
```text
Install the `agentbrowse` skill in Codex from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.8 using `agentbrowse-codex-v0.1.8.zip`. Place the extracted `agentbrowse/` folder directly inside `$CODEX_HOME/skills/` or `~/.codex/skills/`.
...
1. Download `agentbrowse-codex-v0.1.8.zip` from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.8.
...
Use this fallback only if you want to manage the `agentbrowse/` folder yourself instead of asking Codex to install it from https://github.com/MercuryoAI/skills/releases/tag/agentbrowse-v0.1.8 using `agentbrowse-codex-v0.1.8.zip`.

1. Download `agentbrowse-codex-v0.1.8.zip`.
