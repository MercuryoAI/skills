...
```text
Install the `magicbrowse` skill in Codex from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.6 using `magicbrowse-codex-v0.1.6.zip`. Place the extracted `magicbrowse/` folder directly inside `$CODEX_HOME/skills/` or `~/.codex/skills/`.
...
1. Download `magicbrowse-codex-v0.1.6.zip` from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.6.
...
Use this fallback only if you want to manage the `magicbrowse/` folder yourself instead of asking Codex to install it from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.6 using `magicbrowse-codex-v0.1.6.zip`.

1. Download `magicbrowse-codex-v0.1.6.zip`.
