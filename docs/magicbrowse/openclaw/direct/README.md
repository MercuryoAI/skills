...
```text
Install the `magicbrowse` skill in OpenClaw from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.3 using `magicbrowse-openclaw-v0.1.3.zip`. Place the extracted `magicbrowse/` folder directly inside `skills/` or `~/.openclaw/skills/`.
...
1. Download `magicbrowse-openclaw-v0.1.3.zip` from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.3.
...
Use this fallback only if you want to manage the `magicbrowse/` folder yourself instead of asking OpenClaw to install it from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.3 using `magicbrowse-openclaw-v0.1.3.zip`.

1. Download `magicbrowse-openclaw-v0.1.3.zip`.
