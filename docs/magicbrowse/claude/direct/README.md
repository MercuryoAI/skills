...
```text
Install the `magicbrowse` skill in Claude Code from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.14 using `magicbrowse-claude-code-v0.1.14.zip`. Place the extracted `magicbrowse/` folder directly inside `.claude/skills/` or `~/.claude/skills/`.
...
1. Download `magicbrowse-claude-code-v0.1.14.zip` from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.14.
...
Use this fallback only if you want to manage the `magicbrowse/` folder yourself instead of asking Claude Code to install it from https://github.com/MercuryoAI/skills/releases/tag/magicbrowse-v0.1.14 using `magicbrowse-claude-code-v0.1.14.zip`.

1. Download `magicbrowse-claude-code-v0.1.14.zip`.
